        ...
        <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; align-items: center; border: 1px solid var(--border-color); border-radius: var(--radius-sm); background-color: #fff; overflow: hidden; height: 38px;">
                        <span style="background-color: var(--bg-body); padding: 8px 12px; font-size: 13px; color: var(--text-secondary); border-right: 1px solid var(--border-color); user-select: none; display: flex; align-items: center; height: 100%;">Rp</span>
                        <input type="text" name="purchase_price" id="purchase_price" class="form-control" value="{{ old('purchase_price') }}" placeholder="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/\B(?=(\d{3})+(?!\d))/g, '.')" style="border: none; flex-grow: 1; border-radius: 0; outline: none; box-shadow: none; padding: 8px 4px 8px 12px; height: 100%;">
                        <span style="font-size: 13px; color: var(--text-secondary); user-select: none; display: flex; align-items: center; height: 100%; padding-right: 12px;">,00</span>
                    </div>
