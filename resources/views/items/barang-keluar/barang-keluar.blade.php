        ...
        <div class="p-4 md:p-10 pt-4 md:pt-6 space-y-6">
            ...
            <div class="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-wrap items-center gap-3">
                ...
                <div class="relative ml-auto">
                    ...
                    <input type="text" placeholder="Cari peminjam atau barang..." class="pl-9 pr-4 py-2 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-[#3F51B5] outline-none w-64 text-gray-700 placeholder-gray-400" />
                </div>
            </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead class="bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th class="py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider">Tenggat</th>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="py-4 px-6 font-semibold text-sm text-gray-800">Bagus Artandyo</td>
                                <td class="py-4 px-6 text-sm text-gray-700">Macbook Air M2</td>
                                <td class="py-4 px-6 text-sm text-gray-600">Laptop</td>
                                <td class="py-4 px-6 text-sm text-gray-600">10 Apr 2026</td>
                                <td class="py-4 px-6 text-sm text-gray-600">09 Apr 2026</td>
                                <td class="py-4 px-6 text-center">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold bg-red-100 text-red-700">Terlambat</span>
                                </td>
                                <td class="py-4 px-6 text-center">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="py-4 px-6 font-semibold text-sm text-gray-800">Bagus Artandyo</td>
                                <td class="py-4 px-6 text-sm text-gray-700">VGA</td>
                                <td class="py-4 px-6 text-sm text-gray-600">Hardware</td>
                                <td class="py-4 px-6 text-sm text-gray-600">10 Apr 2026</td>
                                <td class="py-4 px-6 text-sm text-gray-600">15 Apr 2026</td>
                                <td class="py-4 px-6 text-center">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold bg-green-100 text-green-700">Selesai</span>
                                </td>
                                <td class="py-4 px-6 text-center">
                                    <a href="#" class="text-[#3F51B5] hover:underline font-medium text-sm">Detail</a>
                                </td>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="py-4 px-6 font-semibold text-sm text-gray-800">Bagus Artandyo</td>
                                <td class="py-4 px-6 text-sm text-gray-700">RAM 8GB</td>
                                <td class="py-4 px-6 text-sm text-gray-600">Hardware</td>
                                <td class="py-4 px-6 text-sm text-gray-600">10 Apr 2026</td>
                                <td class="py-4 px-6 text-sm text-gray-600">15 Apr 2026</td>
                                <td class="py-4 px-6 text-center">
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold bg-blue-100 text-blue-700">Dipinjam</span>
                                </td>
                                <td class="py-4 px-6 text-center">
                                    <a href="#" class="text-[#3F51B5] hover:underline font-medium text-sm">Detail</a>
                                </td>
