<?php $__env->startSection('title', 'Pengaturan Laporan'); ?>
...
<div class="space-y-6 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <form action="<?php echo e(route('laporan.settings.reset')); ?>" method="POST"
    ...
    <section class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        <div class="grid grid-cols-1 gap-3 p-4 sm:grid-cols-2 lg:grid-cols-3 sm:p-5">
            <a href="<?php echo e(route('export.ringkasan.print')); ?>" target="_blank"
            ...
            <a href="<?php echo e(route('export.inventaris.print')); ?>" target="_blank"
            ...
            <a href="<?php echo e(route('export.barang-masuk.print')); ?>" target="_blank"
    ...
    <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <form action="<?php echo e(route('laporan.settings.update')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <section class="p-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="school_name" value="<?php echo e($settings->school_name); ?>" required
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="school_address" value="<?php echo e($settings->school_address); ?>" required
                               class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="school_phone" value="<?php echo e($settings->school_phone); ?>" required
                               class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <textarea name="school_email" rows="2"
                                  ...
                                  placeholder="Contoh: Jl. Ki Ageng Gribig No. 28, Kedungkandang, Malang 65139 | Telp: (0341) 712345"><?php echo e($settings->school_email); ?></textarea>
                    </div>

                    <div class="space-y-1.5 md:col-span-2">
                        <label class="block text-sm font-medium text-slate-700">Website & Email (Baris 5)</label>
                        <input type="text" name="school_website" value="<?php echo e($settings->school_website); ?>" required
                               class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
            ...
            <section class="bg-slate-50/70 p-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="report_title" value="<?php echo e($settings->report_title); ?>" required
                               class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="department_name" value="<?php echo e($settings->department_name); ?>" required
                               class="w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-1.5">
                                ...
                                <input type="text" name="head_of_school_name" value="<?php echo e($settings->head_of_school_name); ?>" required
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="text" name="head_of_school_nip" value="<?php echo e($settings->head_of_school_nip); ?>"
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="text" name="head_of_school_position" value="<?php echo e($settings->head_of_school_position); ?>" required
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            ...
                            <div class="space-y-1.5">
                                ...
                                <?php if($settings->head_of_school_signature): ?>
                                    <div class="group relative flex min-h-20 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 p-3">
                                        <img src="<?php echo e(asset('storage/' . $settings->head_of_school_signature)); ?>" alt="Tanda Tangan" class="max-h-16 max-w-full object-contain">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">Nama</label>
                                <input type="text" name="head_of_department_name" value="<?php echo e($settings->head_of_department_name); ?>" required
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                       placeholder="Nama lengkap">
                            </div>
                            ...
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">NIP</label>
                                <input type="text" name="head_of_department_nip" value="<?php echo e($settings->head_of_department_nip); ?>"
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                       placeholder="Nomor Induk Pegawai">
                            </div>
                            ...
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">Jabatan</label>
                                <input type="text" name="head_of_department_position" value="<?php echo e($settings->head_of_department_position); ?>" required
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            ...
                            <div class="space-y-1.5">
                                ...
                                <?php if($settings->head_of_department_signature): ?>
                                    <div class="group relative flex min-h-20 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 p-3">
                                        <img src="<?php echo e(asset('storage/' . $settings->head_of_department_signature)); ?>" alt="Tanda Tangan" class="max-h-16 max-w-full object-contain">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">Nama</label>
                                <input type="text" name="staff_name" value="<?php echo e($settings->staff_name); ?>" required
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                       placeholder="Nama lengkap">
                            </div>
                            ...
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">NIP</label>
                                <input type="text" name="staff_nip" value="<?php echo e($settings->staff_nip); ?>"
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                                       placeholder="Nomor Induk Pegawai">
                            </div>
                            ...
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">Jabatan</label>
                                <input type="text" name="staff_position" value="<?php echo e($settings->staff_position); ?>" required
                                       class="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm outline-none transition placeholder:text-slate-400 hover:border-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            ...
                            <div class="space-y-1.5">
                                <label class="block text-xs font-medium text-slate-600">Tanda Tangan</label>
                                <?php if($settings->staff_signature): ?>
                                    <div class="group relative flex min-h-20 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 p-3">
                                        <img src="<?php echo e(asset('storage/' . $settings->staff_signature)); ?>" alt="Tanda Tangan" class="max-h-16 max-w-full object-contain">
                ...
                <div class="flex flex-col gap-5 sm:flex-row sm:items-start">
                    ...
                    <?php if($settings->logo_path): ?>
                        <div class="group relative flex h-24 w-24 shrink-0 items-center justify-center rounded-xl border border-slate-200 bg-white p-3">
                            <img src="<?php echo e(asset('storage/' . $settings->logo_path)); ?>" alt="Logo Sekolah" class="max-h-full max-w-full object-contain">
...
<script>
    function deleteSignature(type) {
        if (confirm('Apakah Anda yakin ingin menghapus tanda tangan ini?')) {
            fetch(`<?php echo e(route('laporan.settings.delete-signature', 'type')); ?>`.replace('type', type), {
                method: 'DELETE',
                headers: {
    ...
    function deleteLogo() {
        if (confirm('Apakah Anda yakin ingin menghapus logo ini?')) {
            fetch('<?php echo e(route('laporan.settings.delete-logo')); ?>', {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                    'Content-Type': 'application/json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Project Web Porto\ERP NOC - SMKN 4 Malang\resources\views/laporan/settings.blade.php ENDPATH**/ ?>