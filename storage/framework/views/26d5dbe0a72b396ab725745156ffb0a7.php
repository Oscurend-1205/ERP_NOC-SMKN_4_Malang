...
>
        ...
        <nav class="flex items-center gap-1.5 ml-4 text-xs text-gray-500" aria-label="Breadcrumb">
            ...
            >
                ...
                <?php elseif(request()->routeIs('items.*')): ?>
                    Data Barang
                <?php elseif(request()->routeIs('peminjaman.*')): ?>
                    Data Peminjaman
                <?php elseif(request()->routeIs('procurements.*')): ?>
                    Pengadaan Alat
                <?php elseif(request()->routeIs('perawatan.*')): ?>
                    Data Perawatan
                <?php elseif(request()->routeIs('stock-take.*')): ?>
                    Stok Opname
                <?php elseif(request()->routeIs('laporan.*')): ?>
                    Laporan
                <?php elseif(request()->routeIs('qr.*')): ?>
                    Stasiun QR
                <?php elseif(request()->routeIs('locations.*')): ?>
                    Data Ruangan
                <?php elseif(request()->routeIs('categories.*')): ?>
                    Kategori Barang
                <?php elseif(request()->routeIs('users.*')): ?>
                    Data User
                <?php elseif(request()->routeIs('jurusan.*')): ?>
                    Data Jurusan
                <?php elseif(request()->routeIs('supplier.*')): ?>
                    Data Supplier
                <?php elseif(request()->routeIs('kondisi.*')): ?>
                    Kondisi Barang
                <?php elseif(request()->routeIs('asal.*')): ?>
                    Asal Barang
                <?php elseif(request()->routeIs('activity-log.*')): ?>
                    Audit Trail
                <?php elseif(request()->routeIs('settings.*')): ?>
                    Pengaturan
                <?php elseif(request()->routeIs('notifications.*')): ?>
                    Notifikasi
                <?php elseif(request()->routeIs('profile.*')): ?>
                    Profil
                <?php elseif(request()->routeIs('guide.*')): ?>
                    Panduan Sistem
                <?php else: ?>
                    <?php echo e(Request::segment(1) ? ucfirst(str_replace('-', ' ', Request::segment(1))) : 'Dashboard'); ?>
    ...
    <div class="flex items-center gap-1 md:gap-3 flex-shrink-0">
        ...
        >
            ...
            <span
                class="operational-status font-bold text-[12px] <?php echo e($isOpen ? 'text-emerald-500' : 'text-red-500'); ?>"
            >
    ...
    (function() {
        ...
        if (markAllBtn) {
            ...
            markAllBtn.addEventListener('click', function() {
                ...
                fetch(
                    "<?php echo e(route('notifications.mark-all-read')); ?>",
                    {
                        method: 'POST',
...
</style><?php /**PATH C:\Project Web Porto\ERP NOC - SMKN 4 Malang\resources\views/partials/topbar.blade.php ENDPATH**/ ?>