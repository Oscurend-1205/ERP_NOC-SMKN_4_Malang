...
<div id="erpQuickWidgetContainer" 
    ...
    <div id="erpQuickMenuModal" 
        ...
        <div class="grid grid-cols-2 gap-2">
            ...
            <a href="<?php echo e(route('items.index')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-blue-50 hover:text-blue-700 border border-transparent hover:border-blue-200 transition-all flex items-start gap-2.5">
            ...
            <!-- 2. Pengadaan Alat -->
            <a href="<?php echo e(route('procurements.index')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-amber-50 hover:text-amber-700 border border-transparent hover:border-amber-200 transition-all flex items-start gap-2.5">
            ...
            <a href="<?php echo e(route('qr.admin')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-indigo-50 hover:text-indigo-700 border border-transparent hover:border-indigo-200 transition-all flex items-start gap-2.5">
            ...
            <!-- 4. Peminjaman -->
            <a href="<?php echo e(route('peminjaman.index')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-emerald-50 hover:text-emerald-700 border border-transparent hover:border-emerald-200 transition-all flex items-start gap-2.5">
            ...
            <!-- 5. Stok Opname -->
            <a href="<?php echo e(route('stock-take.index')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-teal-50 hover:text-teal-700 border border-transparent hover:border-teal-200 transition-all flex items-start gap-2.5">
            ...
            <a href="<?php echo e(route('activity-log.index')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-purple-50 hover:text-purple-700 border border-transparent hover:border-purple-200 transition-all flex items-start gap-2.5">
            ...
            <?php else: ?>
            <a href="<?php echo e(route('laporan.index')); ?>" class="group p-2.5 rounded-xl bg-gray-50/80 hover:bg-purple-50 hover:text-purple-700 border border-transparent hover:border-purple-200 transition-all flex items-start gap-2.5">
                <div class="w-8 h-8 rounded-lg bg-purple-100 text-purple-600 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
...
<?php endif; ?>
<?php /**PATH C:\Project Web Porto\ERP NOC - SMKN 4 Malang\resources\views/components/accessibility-button.blade.php ENDPATH**/ ?>